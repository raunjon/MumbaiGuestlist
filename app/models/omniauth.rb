    ...
    def query(code)
      {
          query: {
              ...
              client_id: '429444913898131', # Facebook appId
              client_secret: 'c32d1331f183b1eca22887ef1b166ec1', # Facebook app secret (must not exist on front-end app for security)
          }
      }
    end
  end
