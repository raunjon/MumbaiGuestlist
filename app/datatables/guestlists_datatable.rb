...
class GuestlistsDatatable
  ...
  def fetch_guestlists
    ...
    if params[:sSearch].present?
      #guestlists = guestlists.joins(:user, :club)
      guestlists = guestlists.where("name like :search or title like :search or entry_date like :search like :search or email like :search or guestlists.mobile like :search", search: "%#{params[:sSearch]}%")
    end
    guestlists
  end
